        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    fl_IsSuccess = table.Column<bool>(type: "bit", nullable: false),
                    ds_HttpMethod = table.Column<string>(type: "NVARCHAR(10)", maxLength: 10, nullable: false),
                    ...
                    ds_RequestBody = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ds_RequestHeaders = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ds_ResponseBody = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ds_ErrorMessage = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ds_TenantId = table.Column<string>(type: "NVARCHAR(100)", maxLength: 100, nullable: true),
                    ds_CorrelationId = table.Column<string>(type: "NVARCHAR(64)", maxLength: 64, nullable: true),
                    ds_TraceId = table.Column<string>(type: "NVARCHAR(64)", maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    ds_Message = table.Column<string>(type: "NVARCHAR(255)", maxLength: 255, nullable: false),
                    ds_StackTrace = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ds_TenantId = table.Column<string>(type: "NVARCHAR(100)", maxLength: 100, nullable: true),
                    ds_CorrelationId = table.Column<string>(type: "NVARCHAR(64)", maxLength: 64, nullable: true),
                    ds_TraceId = table.Column<string>(type: "NVARCHAR(64)", maxLength: 64, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dt_CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    nm_Process = table.Column<string>(type: "NVARCHAR(255)", maxLength: 255, nullable: true),
                    ds_TenantId = table.Column<string>(type: "NVARCHAR(100)", maxLength: 100, nullable: true),
                    ds_CorrelationId = table.Column<string>(type: "NVARCHAR(64)", maxLength: 64, nullable: true),
                    ds_TraceId = table.Column<string>(type: "NVARCHAR(64)", maxLength: 64, nullable: true)
                },
